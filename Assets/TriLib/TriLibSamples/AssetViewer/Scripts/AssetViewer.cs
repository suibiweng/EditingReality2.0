...
namespace TriLibCore.Samples
{
    ...
    public class AssetViewer : AssetViewerBase
    {
        ...
        /// <summary>
        /// "Load Model from Directory" button
        /// </summary>
        [SerializeField]
        private GameObject _loadModelFromDirectory;

        /// <summary>
        /// Fast Load Toggle. This toggle configures the AssetLoaderOptions with fast options, but with some restrictions.
        /// Please refer to "OnFastLoadToggleChanged".
        /// </summary>
        [SerializeField]
        ...
        /// <summary>
        /// Reference to the shader used to display vertex colors.
        /// </summary>
        private Shader _showVertexColorsShader;

        /// <summary>
        /// Indicates whether an AssetLoaderOptions has been set by the Unity inspector.
        /// </summary>
        ...
        public void LoadModelFromDirectory()
        {
            ...
            AssetLoaderOptions.ImportLights = _loadLightsToggle.isOn;
            AssetLoaderOptions.LoadPointClouds = _loadPointClouds.isOn;
            base.LoadModelFromDirectory(null, null);
        }
        ...
        /// </summary>
        /// <param name="value">The toggle value.</param>
        ...
        public void OnFastLoadToggleChanged(bool value)
        {
            ...
            if (value)
            {
                // Looks for the GLTF and AutodeskInteractive material helpers and use them to setup the additional material mappers, if found.
                ...
                AssetLoaderOptions.ShowLoadingWarnings = true; // Show loading warnings to improve debugging.
                AssetLoaderOptions.UseUnityNativeNormalCalculator = true; // Unity's built-in normal calculator is faster than the TriLib approach but gives more superficial results.
                AssetLoaderOptions.UseUnityNativeTextureLoader = true; // Unity's built-in texture loader is faster than the TriLib approach but accepts PNG and JPEG textures only.
                AssetLoaderOptions.OptimizeMeshes = false; // Mesh optimization takes considerable loading time.
            }
            AssetLoaderOptions.Timeout = 900; // Higher loading timeout for the viewer scene.
            AssetLoaderOptions.UpdateSkinnedMeshRendererWhenOffscreen = true; // Prevents the camera "fitting" code not focusing correctly on partially loaded skinned mesh renderers.
        }
