...
namespace TriLibCore.Samples
{
    ...
    public class AssetViewerBase : AbstractInputSystem
    {
        ...
        protected void LoadModelFromFile(GameObject wrapperGameObject = null, Action<AssetLoaderContext> onMaterialsLoad = null)
        {
            ...
            FilePickerAssetLoader.LoadModelFromFilePickerAsync("Select a File", OnLoad, onMaterialsLoad ?? OnMaterialsLoad, OnProgress, OnBeginLoadModel, OnError, wrapperGameObject ? wrapperGameObject : gameObject, AssetLoaderOptions);
        }

        /// <summary>
        /// Shows the directory picker for loading a model from local file-system.
        /// </summary>
        protected void LoadModelFromDirectory(GameObject wrapperGameObject = null, Action<AssetLoaderContext> onMaterialsLoad = null)
        {
            SetLoading(false);
            FilePickerAssetLoader = AssetLoaderFilePicker.Create();
            FilePickerAssetLoader.LoadModelFromDirectoryPickerAsync("Select a Directory", OnLoad, onMaterialsLoad ?? OnMaterialsLoad, OnProgress, OnBeginLoadModel, OnError, wrapperGameObject ? wrapperGameObject : gameObject, AssetLoaderOptions, true);
        }
