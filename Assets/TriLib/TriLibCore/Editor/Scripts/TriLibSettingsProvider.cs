...
namespace TriLibCore.Editor
{
    public class TriLibSettingsProvider : SettingsProvider
    {
        ...
        public override void OnGUI(string searchContext)
        {
            ...
            EditorGUILayout.Space();
            ShowConditionalToggle("Enable debug libraries", "TRILIB_ENABLE_DEBUG_LIBRARIES");
            ...
            if (GUILayout.Button("TriLib Tools (New)"))
            {
                Application.OpenURL("https://rickomax.itch.io/");
            }
